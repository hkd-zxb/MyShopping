...
public class UserDBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "myshopping.db"; // 数据库的名称
...
//        return insert(infoList);
    ...
    // 往该表添加多条记录
    public void insert(List<UserInfo> infoList) {
//        long result = -1;
...
//            }
    ...
    public List<UserInfo> query(String condition) {
        String sql = String.format("select password from %s where %s;", TABLE_NAME, condition);
        ...
        while (cursor.moveToNext()) {
            ...
            info.password = cursor.getString(0);//取出字符串
            infoList.add(info);
        }
