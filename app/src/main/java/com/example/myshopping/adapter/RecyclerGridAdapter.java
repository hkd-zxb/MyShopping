...
import com.example.myshopping.widget.RecyclerExtras.OnItemClickListener;
import com.example.myshopping.widget.RecyclerExtras.OnItemLongClickListener;
...
public class RecyclerGridAdapter extends RecyclerView.Adapter<ViewHolder> implements
    ...
    public ViewHolder onCreateViewHolder(ViewGroup vg, int viewType) {
        ...
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_mobile1, vg, false);
