...
public class RecyclerOtherAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private List<NewsInfo> mGoodsList;

    public RecyclerOtherAdapter(Context mContext, List<NewsInfo> mGoodsList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_other, parent, false);
