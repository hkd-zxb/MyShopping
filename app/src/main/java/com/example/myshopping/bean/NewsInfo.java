...
public class NewsInfo {
    ...
    private static int[] gridImageArray = {R.drawable.pic_1, R.drawable.pic_02, R.drawable.pic_03
    ...
    private static int[] stagImageArray = {R.drawable.skirt01, R.drawable.skirt04, R.drawable.skirt02
            , R.drawable.skirt03, R.drawable.skirt02, R.drawable.skirt01, R.drawable.skirt04
            , R.drawable.skirt01, R.drawable.skirt02, R.drawable.skirt04, R.drawable.skirt01
            , R.drawable.skirt04, R.drawable.skirt02, R.drawable.skirt03, R.drawable.skirt01
            , R.drawable.skirt01, R.drawable.skirt03, R.drawable.skirt02, R.drawable.skirt01
            , R.drawable.skirt03, R.drawable.skirt01, R.drawable.skirt04, R.drawable.skirt02,R.drawable.dianqi01};
    private static String[] stagTitleArray = {"促销价", "惊爆价", "跳楼价", "白菜价", "清仓价", "割肉价",
            "实惠价", "一口价", "满意价", "打折价", "腰斩价", "无人问津", "算了吧", "大声点",
            "嘘嘘", "嗯嗯", "呼呼", "呵呵", "哈哈", "嘿嘿", "嘻嘻", "嗷嗷", "喔喔","aaa"};
