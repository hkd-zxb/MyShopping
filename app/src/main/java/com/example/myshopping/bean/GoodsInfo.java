...
public class GoodsInfo {
    ...
    private static String[] mNameArray = {
            "iPhone11", "Mate30", "小米10", "OPPO Reno3", "vivo X30", "荣耀30S","吹风机"
    };
    // 声明一个手机商品的描述数组
    private static String[] mDescArray = {
            ...
            "荣耀30S 8GB+128GB 蝶羽红 5G芯片 自拍全面屏手机1"
    };
    // 声明一个手机商品的价格数组
    private static float[] mPriceArray = {6299, 4999, 3999, 2999, 2998, 2399,1999};
    // 声明一个手机商品的大图数组
    private static int[] mPicArray = {
            R.drawable.iphone, R.drawable.huawei, R.drawable.xiaomi,
            R.drawable.oppo, R.drawable.vivo, R.drawable.rongyao,R.drawable.dianqi01
    };
